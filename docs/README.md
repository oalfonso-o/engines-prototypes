...
This folder tracks early design decisions and working assumptions for `canuter`.

Current document set:

- `01-product-vision.md`: product direction and high-level goals.
- `02-gameplay-core.md`: round structure, factions, combat, controls, and camera/visibility rules.
