...
const PLAYER_SPAWN: Vector3 = Vector3(4.5, 1.2, 5.5)
const GROUND_SIZE: Vector3 = Vector3(18.0, 0.2, 18.0)
const RUNTIME_PATH: String = "res://data/runtime_ramp_debug_3x3.json"
...
func _build_world() -> void:
	...
	voxel_world.runtime_path = RUNTIME_PATH
