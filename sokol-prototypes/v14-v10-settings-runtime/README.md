# V14 V10 Settings Runtime

`v14` keeps `v10` behavior and cube-only logic, but moves hardcoded runtime and preprocess configuration into `settings.json`.
...
```bash
SETTINGS_PATH=./settings.json make run
```
