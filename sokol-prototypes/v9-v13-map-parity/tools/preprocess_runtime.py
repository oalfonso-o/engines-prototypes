...
MATERIAL_COLORS: dict[str, tuple[float, float, float, float]] = {
    "gray": (0.525, 0.545, 0.573, 1.0),
    "green": (0.435, 0.584, 0.443, 1.0),
    "purple": (0.525, 0.427, 0.584, 1.0),
    "metal": (0.659, 0.639, 0.604, 1.0),
}
FACE_SHADE: dict[tuple[int, int, int], float] = {
    (0, 1, 0): 1.00,
    (0, -1, 0): 0.62,
    (0, 0, 1): 0.94,
    (0, 0, -1): 0.74,
...
OUTPUT_PATH = REPO_ROOT / "sokol-prototypes" / "v9-v13-map-parity" / "data" / "runtime_world.json"
...
def main() -> None:
    ...
    world_y_offset = 0.02
    write_runtime(world, quads_by_material, boxes, world_y_offset)
