...
bool runtime_world_load(const char* artifact_path, const ProjectSettings* settings, RuntimeWorld* out_world) {
    ...
    @autoreleasepool {
        ...
        out_world->spawn.override_enabled = [spawn[@"override_enabled"] boolValue];
        out_world->spawn.override_position = vec3_make([override_position[0] floatValue], [override_position[1] floatValue], [override_position[2] floatValue]);
